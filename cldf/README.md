...
`Archive` | `string` | 
`Archive_link` | `string` | 
`AnnotationLicense` | `string`<br>Regex: `CC BY|CC BY-NC-SA|CC BY-NC` | 
`AudioLicense` | `string` | 
`DOI` | `string` | 
